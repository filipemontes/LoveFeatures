...
slang_dict = {
    ...
    "bwe": "bue", "s": "sim", "mm": "mesmo", "agr": "agora", "min": "minutos", "tp": "tipo", "tou": "estou" ,"to": "estou"
}
...
def process_and_group_chat(file, time_limit_minutes=1):
    ...
    # Extract emojis
    grouped_df["Emojis"] = grouped_df["Message"].apply(extract_emojis)

    # Sentiment analysis
    grouped_df["Sentiment"] = grouped_df["Processed_Message"].apply(lambda x: TextBlob(x).sentiment.polarity)
